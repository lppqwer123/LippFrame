...
public final class StringUtils {
    ...
    public static void setTextTwoLast(Context context, TextView tv, String before, String last, int color, int size) {
        ...
        spanString.setSpan(new AbsoluteSizeSpan(DisplayUtils.dp2px(size)), before.length(), spanString.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        tv.setText(spanString);
    }

    public static void setTextTwoLast(Context context, TextView tv, String before, String last, int color) {
        SpannableString spanString = new SpannableString(before + last);
        spanString.setSpan(new ForegroundColorSpan(context.getResources().getColor(color)), before.length(), spanString.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE); // 设置前景色为洋红色
        tv.setText(spanString);
    }

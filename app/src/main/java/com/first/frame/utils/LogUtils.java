...
public class LogUtils {
    ...
    // 自定义Tag的前缀
    public static String TAG_PREFIX = "LIPP";
    ...
    public static final String ROOT = Environment.getExternalStorageDirectory().getPath()
            + "/"+ FrameApplication.getContext().getString(R.string.app_name)+"/";
    ...
    private static String generateTag(StackTraceElement caller) {
        ...
        tag = StringUtils.isEmpty(TAG_PREFIX) ? tag : TAG_PREFIX + ":" + tag;
        return tag;
    }

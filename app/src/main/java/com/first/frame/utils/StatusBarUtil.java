...
public class StatusBarUtil {
    ...
    public static void setStatusBarTextColor(Activity activity, boolean darkMode) {

        String system = SystemHelper.getSystem();
        LogUtils.d("system=="+system);
        if (system.equals(SystemHelper.SYS_MIUI)) {

            setMiuiStatusBarDarkMode(activity.getWindow(),darkMode);

        }else if (system.equals(SystemHelper.SYS_FLYME)){
            setMeizuStatusBarDarkIcon(activity.getWindow(),darkMode);
        }else {
